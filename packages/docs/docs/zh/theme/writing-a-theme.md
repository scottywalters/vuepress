...
- `theme/global-components`: 该目录下的组件都会被自动注册为全局组件。想了解更多，请参考 [@vuepress/plugin-register-components](https://github.com/scottywalters/vuepress/tree/master/packages/@vuepress/plugin-register-components)。
